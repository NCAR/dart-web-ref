...
Aether is a flexible, community-based upper atmosphere ensemble prediction
system with quantifiable uncertainty to accelerate scientific advances and
model improvement.

The project is a collaboration between the University of Michigan, NCAR, NASA
Goddard Spaceflight Center and the Naval Research Laboratory.

The core personnel are as follows:
